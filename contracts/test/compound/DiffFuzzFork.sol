...
interface ICErc20Delegate {
    ...
    function _becomeImplementation(bytes memory) external;
...
contract DiffFuzzUpgrades {
    ...
    constructor() public {
        ...
        cTUSD = ICErc20Delegate(0x12392F67bdf24faE0AF363c24aC620a2f67DAd86);
    }
    ...
    function Comptroller__upgradeSplitCompRewards() public virtual {
    ...
    function Comptroller_compSpeeds(address a) public virtual returns (uint256) {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
    ...
    function cTUSD__acceptAdmin() public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
                '_acceptAdmin()'
            )
        );
        hevm.selectFork(fork2);
        emit SwitchedFork(fork2);
        (bool successV2, bytes memory outputV2) = address(cTUSD).call(
            abi.encodeWithSignature(
                '_acceptAdmin()'
            )
        );
    ...
    function cTUSD__addReserves(uint256 a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD__becomeImplementation(bytes memory a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
                '_becomeImplementation(bytes)', a
            )
        );
        hevm.selectFork(fork2);
        emit SwitchedFork(fork2);
    ...
    function cTUSD__delegateCompLikeTo(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD__reduceReserves(uint256 a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD__resignImplementation() public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD__setComptroller(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD__setInterestRateModel(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD__setPendingAdmin(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD__setReserveFactor(uint256 a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD_accrueInterest() public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_allowance(address a, address b) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_approve(address a, uint256 b) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_balanceOf(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_balanceOfUnderlying(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_borrow(uint256 a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD_borrowBalanceCurrent(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_borrowBalanceStored(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_borrowRatePerBlock() public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_exchangeRateCurrent() public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_exchangeRateStored() public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_getAccountSnapshot(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_getCash() public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_initialize(address a, address b, address c, uint256 d, string memory e, string memory f, uint8 g) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD_initialize(address a, address b, uint256 c, string memory d, string memory e, uint8 f) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD_liquidateBorrow(address a, uint256 b, address c) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD_mint(uint256 a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD_redeem(uint256 a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD_redeemUnderlying(uint256 a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD_repayBorrow(uint256 a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD_repayBorrowBehalf(address a, uint256 b) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD_seize(address a, address b, uint256 c) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD_supplyRatePerBlock() public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_sweepToken(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_totalBorrowsCurrent() public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
    ...
    function cTUSD_transfer(address a, uint256 b) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
    ...
    function cTUSD_transferFrom(address a, address b, uint256 c) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(cTUSD).call(
            abi.encodeWithSignature(
