...
import { Safemoon_15 } from "../../../mutants/Safemoon_15.sol";
...
contract DiffFuzzUpgrades {
    ...
    constructor() public {
        ...
        safemoon15V2 = ISafemoon_15V2(0x0102030405060708091011121314151617181920);
    ...
    function Safemoon_15_isExcludedFromReward(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
    ...
    function Safemoon__burnAddress() public virtual returns (address) {
        ...
        hevm.selectFork(fork2);
        emit SwitchedFork(fork2);
        address a2 = ISafemoon_15V2(address(transparentUpgradeableProxy))._burnAddress();
        assert(a1 == a2);
        return a1;
    }
    ...
    function Safemoon__maxTxAmount() public virtual returns (uint256) {
        ...
        hevm.selectFork(fork2);
        emit SwitchedFork(fork2);
        uint256 a2 = ISafemoon_15V2(address(transparentUpgradeableProxy))._maxTxAmount();
        assert(a1 == a2);
        return a1;
    }
