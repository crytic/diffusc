...
import { Safemoon_04 as Safemoon_04_V2 } from "../../../mutants/Safemoon_04.sol";
...
contract DiffFuzzUpgrades {
    ...
    constructor() public {
        ...
        safemoon04V2 = ISafemoon_04V2(address(new Safemoon_04_V2()));
    ...
    function Safemoon__burnAddress() public virtual returns (address) {
        assert(ISafemoonV1(address(transparentProxyTestHarnessV1))._burnAddress() == ISafemoon_04V2(address(transparentProxyTestHarnessV2))._burnAddress());
    ...
    function Safemoon__maxTxAmount() public virtual returns (uint256) {
        assert(ISafemoonV1(address(transparentProxyTestHarnessV1))._maxTxAmount() == ISafemoon_04V2(address(transparentProxyTestHarnessV2))._maxTxAmount());
