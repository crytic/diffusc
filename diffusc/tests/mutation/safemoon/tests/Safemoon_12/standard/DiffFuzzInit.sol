...
contract DiffFuzzInit is DiffFuzzUpgrades {
    constructor() DiffFuzzUpgrades() {
        ...
        hevm.prank(msg.sender);
        ISafemoon_12V2(address(transparentProxyTestHarnessV2)).initialize();
    }

    function Safemoon_12_transfer(address a, uint256 b) public override {
        require(a != address(transparentProxyTestHarnessV1) && a != address(transparentProxyTestHarnessV2));
        super.Safemoon_12_transfer(a, b);
    }
}