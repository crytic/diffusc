...
import { Safemoon_05 as Safemoon_05_V2 } from "../../../mutants/Safemoon_05.sol";
...
contract DiffFuzzUpgrades {
    ...
    constructor() public {
        ...
        safemoon05V2 = ISafemoon_05V2(address(new Safemoon_05_V2()));
    ...
    function Safemoon__burnAddress() public virtual returns (address) {
        assert(ISafemoonV1(address(transparentProxyTestHarnessV1))._burnAddress() == ISafemoon_05V2(address(transparentProxyTestHarnessV2))._burnAddress());
    ...
    function Safemoon__maxTxAmount() public virtual returns (uint256) {
        assert(ISafemoonV1(address(transparentProxyTestHarnessV1))._maxTxAmount() == ISafemoon_05V2(address(transparentProxyTestHarnessV2))._maxTxAmount());
