...
import { Safemoon_18 as Safemoon_18_V2 } from "../../../mutants/Safemoon_18.sol";
...
contract DiffFuzzUpgrades {
    ...
    constructor() public {
        ...
        safemoon18V2 = ISafemoon_18V2(address(new Safemoon_18_V2()));
        ...
        hevm.store(
            ...
            bytes32(uint(24440054405305269366569402256811496959409073762505157381672968839269610695612)),
            bytes32(uint256(uint160(address(safemoon18V2))))
        );
    }
...
function Safemoon_18_excludeFromReward(address a) public virtual {
    ...
    function Safemoon_18_includeInReward(address a) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_18_initialize() public virtual {
    ...
    function Safemoon_18_balanceOf(address a) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'balanceOf(address)', a
    ...
    function Safemoon_18_transfer(address a, uint256 b) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_18_transferFrom(address a, address b, uint256 c) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_18_isExcludedFromReward(address a) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_18_reflectionFromTokenInTiers(uint256 a, uint256 b, bool c) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_18_reflectionFromToken(uint256 a, bool b) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_18_tokenFromReflection(uint256 a) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_18_setEcoSystemFeeAddress(uint256 a, address b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_18_setOwnerFeeAddress(uint256 a, address b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_18_addTier(uint256 a, uint256 b, uint256 c, uint256 d, uint256 e, address f, address g) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_18_migrate(address a, uint256 b) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_18_updateBurnAddress(address a) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_18_getContractBalance() public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'getContractBalance()'
    ...
    function Safemoon_18_mint(address a, uint256 b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_18_burn(uint256 a) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'burn(uint256)', a
            )
    ...
    function Safemoon__burnAddress() public virtual returns (address) {
        assert(ISafemoonV1(address(transparentProxyTestHarnessV1))._burnAddress() == ISafemoon_18V2(address(transparentProxyTestHarnessV2))._burnAddress());
    ...
    function Safemoon__maxTxAmount() public virtual returns (uint256) {
        assert(ISafemoonV1(address(transparentProxyTestHarnessV1))._maxTxAmount() == ISafemoon_18V2(address(transparentProxyTestHarnessV2))._maxTxAmount());
