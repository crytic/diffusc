...
import { Safemoon_27 as Safemoon_27_V2 } from "../../../mutants/Safemoon_27.sol";
...
contract DiffFuzzUpgrades {
    ...
    constructor() public {
        ...
        safemoon27V2 = ISafemoon_27V2(address(new Safemoon_27_V2()));
        ...
        hevm.store(
            ...
            bytes32(uint(24440054405305269366569402256811496959409073762505157381672968839269610695612)),
            bytes32(uint256(uint160(address(safemoon27V2))))
        );
    }
    ...
    function Safemoon_27_migrate(address a, uint256 b) public virtual {
    ...
    function Safemoon_27_initialize() public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'initialize()'
    ...
    function Safemoon_27_balanceOf(address a) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'balanceOf(address)', a
    ...
    function Safemoon_27_transfer(address a, uint256 b) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_transferFrom(address a, address b, uint256 c) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_totalFees() public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'totalFees()'
    ...
    function Safemoon_27_reflectionFromTokenInTiers(uint256 a, uint256 b, bool c) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_reflectionFromToken(uint256 a, bool b) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_tokenFromReflection(uint256 a) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_excludeFromReward(address a) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_includeInReward(address a) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_whitelistAddress(address a, uint256 b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_accountTier(address a) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_setEcoSystemFeePercent(uint256 a, uint256 b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_setLiquidityFeePercent(uint256 a, uint256 b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_setTaxFeePercent(uint256 a, uint256 b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_setOwnerFeePercent(uint256 a, uint256 b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_setBurnFeePercent(uint256 a, uint256 b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_setEcoSystemFeeAddress(uint256 a, address b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_setOwnerFeeAddress(uint256 a, address b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_addTier(uint256 a, uint256 b, uint256 c, uint256 d, uint256 e, address f, address g) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_feeTier(uint256 a) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'feeTier(uint256)', a
    ...
    function Safemoon_27_feeTiersLength() public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'feeTiersLength()'
    ...
    function Safemoon_27_updateBurnAddress(address a) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_getContractBalance() public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'getContractBalance()'
    ...
    function Safemoon_27_mint(address a, uint256 b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_27_burn(uint256 a) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'burn(uint256)', a
            )
    ...
    function Safemoon__burnAddress() public virtual returns (address) {
        assert(ISafemoonV1(address(transparentProxyTestHarnessV1))._burnAddress() == ISafemoon_27V2(address(transparentProxyTestHarnessV2))._burnAddress());
    ...
    function Safemoon__maxTxAmount() public virtual returns (uint256) {
        assert(ISafemoonV1(address(transparentProxyTestHarnessV1))._maxTxAmount() == ISafemoon_27V2(address(transparentProxyTestHarnessV2))._maxTxAmount());
