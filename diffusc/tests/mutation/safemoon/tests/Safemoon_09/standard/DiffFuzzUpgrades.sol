...
import { Safemoon_09 as Safemoon_09_V2 } from "../../../mutants/Safemoon_09.sol";
...
contract DiffFuzzUpgrades {
    ...
    constructor() public {
        ...
        safemoon09V2 = ISafemoon_09V2(address(new Safemoon_09_V2()));
        ...
        hevm.store(
            ...
            bytes32(uint(24440054405305269366569402256811496959409073762505157381672968839269610695612)),
            bytes32(uint256(uint160(address(safemoon09V2))))
        );
    }
...
function Safemoon_09_excludeFromReward(address a) public virtual {
    ...
    function Safemoon_09_includeInReward(address a) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_09_initialize() public virtual {
    ...
    function Safemoon_09_balanceOf(address a) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'balanceOf(address)', a
    ...
    function Safemoon_09_transfer(address a, uint256 b) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_09_transferFrom(address a, address b, uint256 c) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_09_isExcludedFromReward(address a) public virtual {
    function Safemoon_09_reflectionFromTokenInTiers(uint256 a, uint256 b, bool c) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_09_reflectionFromTokenInTiers(uint256 a, uint256 b, bool c) public virtual {
    function Safemoon_09_reflectionFromToken(uint256 a, bool b) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'reflectionFromTokenInTiers(uint256,uint256,bool)', a, b, c
    ...
    function Safemoon_09_reflectionFromToken(uint256 a, bool b) public virtual {
    function Safemoon_09_tokenFromReflection(uint256 a) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'reflectionFromToken(uint256,bool)', a, b
    ...
    function Safemoon_09_setEcoSystemFeeAddress(uint256 a, address b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_09_setOwnerFeeAddress(uint256 a, address b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_09_addTier(uint256 a, uint256 b, uint256 c, uint256 d, uint256 e, address f, address g) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_09_migrate(address a, uint256 b) public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_09_updateBurnAddress(address a) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_09_getContractBalance() public virtual {
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'getContractBalance()'
    ...
    function Safemoon_09_mint(address a, uint256 b) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_09_burn(uint256 a) public virtual {
        (bool successV1, bytes memory outputV1) = address(transparentProxyTestHarnessV1).call(
            abi.encodeWithSignature(
                'burn(uint256)', a
            )
    ...
    function Safemoon__burnAddress() public virtual returns (address) {
        assert(ISafemoonV1(address(transparentProxyTestHarnessV1))._burnAddress() == ISafemoon_09V2(address(transparentProxyTestHarnessV2))._burnAddress());
    ...
    function Safemoon__maxTxAmount() public virtual returns (uint256) {
        assert(ISafemoonV1(address(transparentProxyTestHarnessV1))._maxTxAmount() == ISafemoon_09V2(address(transparentProxyTestHarnessV2))._maxTxAmount());
