...
import { Safemoon_09 } from "../../../mutants/Safemoon_09.sol";
...
contract DiffFuzzUpgrades {
    ...
    constructor() public {
        ...
        safemoon09V2 = ISafemoon_09V2(0x0102030405060708091011121314151617181920);
    ...
    function Safemoon__burnAddress() public virtual returns (address) {
        ...
        hevm.selectFork(fork2);
        emit SwitchedFork(fork2);
        address a2 = ISafemoon_09V2(address(transparentUpgradeableProxy))._burnAddress();
        assert(a1 == a2);
        return a1;
    }
    ...
    function Safemoon__maxTxAmount() public virtual returns (uint256) {
        ...
        hevm.selectFork(fork2);
        emit SwitchedFork(fork2);
        uint256 a2 = ISafemoon_09V2(address(transparentUpgradeableProxy))._maxTxAmount();
        assert(a1 == a2);
        return a1;
    }
