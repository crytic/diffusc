...
import { Safemoon_03 } from "../../../mutants/Safemoon_03.sol";
...
contract DiffFuzzUpgrades {
    ...
    constructor() public {
        ...
        safemoon03V2 = ISafemoon_03V2(0x0102030405060708091011121314151617181920);
        ...
        hevm.store(
            address(transparentUpgradeableProxy),
            bytes32(uint(24440054405305269366569402256811496959409073762505157381672968839269610695612)),
            bytes32(uint256(uint160(address(safemoon03V2))))
        );
    }
    ...
    function Safemoon_03_excludeFromReward(address a) public virtual {
        hevm.selectFork(fork1);
    ...
    function Safemoon_03_includeInReward(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_03_initialize() public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
    ...
    function Safemoon_03_balanceOf(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
    ...
    function Safemoon_03_transfer(address a, uint256 b) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
    ...
    function Safemoon_03_transferFrom(address a, address b, uint256 c) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
    ...
    function Safemoon_03_isExcludedFromReward(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
    ...
    function Safemoon_03_reflectionFromTokenInTiers(uint256 a, uint256 b, bool c) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
    ...
    function Safemoon_03_reflectionFromToken(uint256 a, bool b) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
    ...
    function Safemoon_03_tokenFromReflection(uint256 a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
    ...
    function Safemoon_03_setEcoSystemFeeAddress(uint256 a, address b) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_03_setOwnerFeeAddress(uint256 a, address b) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_03_addTier(uint256 a, uint256 b, uint256 c, uint256 d, uint256 e, address f, address g) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_03_migrate(address a, uint256 b) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
    ...
    function Safemoon_03_updateBurnAddress(address a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_03_getContractBalance() public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        hevm.prank(msg.sender);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
    ...
    function Safemoon_03_mint(address a, uint256 b) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
            abi.encodeWithSignature(
    ...
    function Safemoon_03_burn(uint256 a) public virtual {
        hevm.selectFork(fork1);
        emit SwitchedFork(fork1);
        (bool successV1, bytes memory outputV1) = address(transparentUpgradeableProxy).call(
            abi.encodeWithSignature(
    ...
    function Safemoon__burnAddress() public virtual returns (address) {
        ...
        hevm.selectFork(fork2);
        emit SwitchedFork(fork2);
        address a2 = ISafemoon_03V2(address(transparentUpgradeableProxy))._burnAddress();
        assert(a1 == a2);
        return a1;
    }
    ...
    function Safemoon__maxTxAmount() public virtual returns (uint256) {
        ...
        hevm.selectFork(fork2);
        emit SwitchedFork(fork2);
        uint256 a2 = ISafemoon_03V2(address(transparentUpgradeableProxy))._maxTxAmount();
        assert(a1 == a2);
        return a1;
    }
