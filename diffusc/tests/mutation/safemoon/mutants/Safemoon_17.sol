...
contract Safemoon_17 is ISafemoon, Initializable, ContextUpgradeable, OwnableUpgradeable {
    ...
    function swapAndEvolve() public onlyOwner lockTheSwap {
        ...
        addLiquidity(swapeedToken, half);
        emit SwapAndEvolve(half, swapeedToken, half);
    }
