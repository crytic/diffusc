...
contract Safemoon_23 is ISafemoon, Initializable, ContextUpgradeable, OwnableUpgradeable {
    ...
    function _takeFees(
        ...
        _takeFee(sender, values.tEchoSystem, address(0));
        _takeFee(sender, values.tOwner, address(0));
